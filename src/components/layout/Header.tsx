  ...
  return (
    <header
      className={cn(
        ...
        'bg-red-900/85 backdrop-blur-xl border-b border-white/10',
        isScrolled && 'bg-red-900/95 shadow-2xl shadow-black/20'
      )}
    >
      {/* Top Bar */}
      <div className="bg-black/20 border-b border-white/5">
        <div className="container-custom flex items-center justify-between gap-4 py-2 text-sm text-white/70">
          <div className="hidden md:flex items-center gap-3">
            ...
            <span>Now booking projects for Spring 2026</span>
          </div>
      ...
      <nav className="container-custom py-4">
            ...
            <div className="w-10 h-10">
              <svg viewBox="0 0 48 48" className="w-full h-full">
                ...
                <path
                  ...
                  strokeLinecap="round"
                />
                <circle cx="34" cy="8" r="3" fill="url(#logoGrad)" opacity="0.6" />
              </svg>
            </div>
            ...
            {NAV_LINKS.map((link) => (
              <Link
                ...
                className={cn(
                  ...
                  'after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-yellow-500 after:rounded-full after:transition-all',
                  'hover:after:w-full',
        ...
        <div
          className={cn(
            'lg:hidden absolute top-full left-0 right-0 bg-red-900/98 backdrop-blur-xl border-t border-white/10',
